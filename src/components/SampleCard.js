...
const SampleCard = ({ image, price }) => {
 return (
   <div className="relative flex-shrink-0 w-24 h-32 bg-white rounded-lg shadow-sm overflow-hidden mb-1">
     ...
     <div className="absolute bg-red-600 text-white text-xs font-light px-1 py-0.2 rounded rounded-bl-none rounded-tr-none rounded-br-lg rounded-tl-lg flex items-center space-x-1">
