...
const SearchBar = () => {
    ...
    const borderClass = hasScrolled ? 'border-black' : 'border-gray-300';
    ...
    return (
        <form onSubmit={handleSubmit} className="relative w-full max-w-[640px] transition-colors duration-300">
            <input
                type="text"
