...
const HomeWhatsappSection = () => {
    return (
        <div className="px-3 py-5 bg-blue-200">
            <div className="w-full flex flex-col gap-3 justify-center items-center">
                <h2 className="text-xl font-bold">Tu as des question ?</h2>
                <Link to="#" className="text-center">Cliques ici pour lire motre FAQ <br/> ou</Link>
            </div>
