...
import PersonnalInfo from "../../components/Modals/PersonnalInfo";
    ...
    return (
        <Layout>
            ...
            <div className="bg-gray-200 mt-1 py-4 px-3">
                <button onClick={toggleModal} className="py-2 px-2 w-full bg-blue-950 text-white rounded shadow font-medium">Je valide</button>
            </div>
        </Layout>
    );
}
